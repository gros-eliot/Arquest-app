<!---->
<!---->
<!--ANCIENNE PAGE "QuestCreateView.vue" : ne pas l'utiliser dans le router-->
<!---->
<!---->
    ...
    <div class="row">
      <form @submit.prevent="saisie" class="container">
        <div class="input-group">
          ...
          <input type="text" v-model="titre" class="form-control" placeholder="Titre de la quête" />
        </div>
        <br />
        ...
        <div class="input-group">
          ...
          <input type="text" v-model="note" class="form-control" placeholder="Note" />
        </div>
        <br />
    ...
    <div class="row">
      <ol>
        ...
        <li v-for="quest in liste" :key="quest.id" class="text-white">
          id: {{ quest.id }} - {{ quest.titre }} {{ quest.note }} {{ quest.categorie }} {{ quest.date }} {{ quest.difficulte }}
        </li>
      </ol>
    </div>
    <hr />
...
export default {
  data() {
    return {
      ...
      listeCategorie: ["Sport", "Social", "Gestion", "Travail", "DIY", "Santé", "Culture", "Maison"],
