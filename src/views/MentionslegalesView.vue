  ...
  <div class="bg-black ...">
    ...
    <p class="text-white">
      ...
      assidûment.
        ...
        <h2 class="text-5xl text-left ml-16 mb-10 text-white">Responsables  éditorial & légal</h2>
    
        <p class="text-base font-roboto ml-16 mb-11 text-white">Nom de la strucutre - Arquest </p>
        <p class="text-base font-roboto ml-16 mb-11 text-white"> Représentée par - Matthieu Hoareau, Eliot Gros, Héléna Jaegle </p>
        <p class="text-base font-roboto ml-16 mb-20 text-white"> E-mail - Arquest@gmail.com </p>

        <h2 class="text-5xl text-left ml-16 mb-10 text-white"> Editeur du site</h2>

        <p class="text-base font-roboto ml-16 mb-11 text-white"> IUT Belfort-Montbéliard campus de Montbéliard BUT Métiers du Multimédia et de l’internet 19 Av. du Maréchal Juin, 90016 Belfort </p>
        <p class="text-base font-roboto ml-16 mb-11 text-white"> Représenté par les étudiants de première année - JAEGLE Héléna - HOAREAU Matthieu - GROS Eliot </p>
        <p class="text-base font-roboto ml-16 mb-20 text-white"> David@malsot.com Tuteur  légal des étudiants - David Malsot</p>

        <h2 class="text-5xl text-left ml-16 mb-10 text-white"> Hébergeur </h2>

        <p class="text-base font-roboto ml-16 mb-11 text-white"> Nom de la structure - Infomaniak & Netlify </p>
        <p class="text-base font-roboto ml-16 mb-11 text-white"> Representée par - Chris McCraw & Boris Siegenthaler </p>
        <p class="text-base font-roboto ml-16 mb-20 text-white"> Adresse Infomaniak - Rue Eugène-Marziano 25 1227 Les Acacias Netlify - 2325 3rd Street, Suite 296, San Francisco, California 94107. </p>

        <h2 class="text-5xl text-left ml-16 mb-10 text-white"> Conditions générales de vente </h2>
